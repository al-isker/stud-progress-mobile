...
import { Animated, Pressable, View, useAnimatedValue } from 'react-native';
...
export const PressableIOS = forwardRef<View, PressableProps>(
	function PressableIOS(
		{ children, feedbackColor, style, onPressIn, onPressOut, ...props },
		forwardedRef
	) {
